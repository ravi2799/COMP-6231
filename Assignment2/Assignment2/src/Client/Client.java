...
public class Client {
	...
	private static void startapplication(NamingContextExt ncRef) {
	...
	private static void admin(String username, NamingContextExt ncRef) throws Exception {
		//check server of admin
		String serverport = decide_server(username , ncRef);
		if(serverport == "1") {
			startapplication(ncRef);
			//return;
		}
...
//			}
	...
	private static String decide_server(String username, NamingContextExt ncRef ) {
		String serverPort="1";
