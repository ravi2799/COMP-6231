...
public class Montreal_Class extends ServerObjectInterfacePOA{
	...
	public synchronized boolean bookAppointment(String patientID, String appointmentID, String appointmentType){
		...
		int check_numbers_of_outerside_app = booking_countcheck.check_appointment_counts(code,data);
