...
public class Sherbrooke_Class extends UnicastRemoteObject implements ServerInterface{
...
//	
	...
	public Sherbrooke_Class() throws RemoteException {
		super();
	...
	@Override
	public String listAppointmentAvailability(String username,String appointmentType) throws RemoteException {
